  ...
  **/
  ...
  public function index() {
    ...
    if(request()->ajax()) {
      ...
      ->editColumn('id_areas', function($order) { return $order->tps_location_districts->tps_location_areas->name; })
      ->editColumn('id_districts', function($order) { return $order->tps_location_districts->name; })
